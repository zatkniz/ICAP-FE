<template>
  <div
    class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 min-h-screen flex items-center"
  >
    <img
...
onMounted(async () => {
  if (process.client) {
    const simpleParallax = (await import("simple-parallax-js")).default;
