    ...
    <main>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
                      ...
                      <div class="mt-6 flex-auto rounded-t-2xl bg-white">
                        <div class="p-4">
                          ...
                          <div class="mt-3 border-t border-gray-200 pt-5">
                            ...
                            >
                              ...
                              >
                                ...
                                <rect
                                  ...
                                  width="270px"
                                  height="144"
                                  fill="url(#:Rt58mm:-gradient)"
                                  clip-path="url(#:Rt58mm:-clip)"
                                  opacity="0.5"
                                ></rect>
                                <path
                                  d="M 16.0000 32.0000L 23.9375 47.4709L 31.8750 39.3576L 39.8125 80.0116L 47.7500 63.6279L 55.6875 79.3140L 63.6250 87.8140L 71.5625 98.9128L 79.5000 71.6366L 87.4375 127.3372L 95.3750 120.1308L 103.3125 112.3023L 111.2500 120.2355L 119.1875 144.6337L 127.1250 176.0000L 135.0625 162.2326L 143.0000 144.3634L 150.9375 152.3953L 158.8750 144.6221L 166.8125 129.9535L 174.7500 103.3517L 182.6875 112.3401L 190.6250 136.2645L 198.5625 129.6337L 206.5000 120.0959L 214.4375 153.2965L 222.3750 136.5233L 230.3125 143.7035L 238.2500 132.5581L 246.1875 159.0494L 254.1250 144.2413L 262.0625 127.0233L 270.0000 103.2209"
                            ...
                            <div
                              class="mt-4 rounded-lg bg-cyan-500 py-2 px-4 text-center text-sm font-semibold text-white"
                            >
                              Trade
                            </div>
            ...
            <div class="relative -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6">
              <p
                class="text-center text-sm font-semibold text-gray-900 lg:text-left"
              >
                As featured in
              </p>
              <ul
      ...
      >
        ...
        <div class="mt-16 md:hidden">
          ...
          >
            <div class="w-full flex-none snap-center px-4 sm:px-6">
              ...
              >
                ...
                <div
                  class="relative aspect-[366/729] mx-auto w-full max-w-[366px]"
                >
                  <div
                    class="absolute inset-y-[calc(1/729*100%)] right-[calc(5/729*100%)] left-[calc(7/729*100%)] rounded-[calc(58/366*100%)/calc(58/729*100%)] shadow-2xl"
                  ></div>
                    ...
                    <div class="flex flex-col w-full">
                      ...
                      <div class="mt-6 px-4 text-white">
                        ...
                        <div class="text-sm text-gray-500">
                          Get tips <span class="text-white">5s sooner</span> for
                          every invite.
                        </div>
                      </div>
                      <div class="mt-6 flex-auto rounded-t-2xl bg-white">
                      ...
                      <div class="mt-6 flex-auto rounded-t-2xl bg-white">
                        <div class="divide-y divide-gray-100">
                          <div class="flex items-center gap-4 px-4 py-3">
                            ...
                            <div class="flex-auto text-sm text-gray-900">
                              Laravel
                            </div>
                            <div class="flex-none text-right">
                              ...
                              <div class="text-xs leading-5 text-cyan-500">
                                +4.98%
                              </div>
                            </div>
                          </div>
                  ...
                  >
                    <div class="flex flex-col w-full">
                      ...
                      <div class="mt-6 px-4 text-white">
                        ...
                        <div class="text-sm text-gray-500">
                          <span class="text-white">$34.28</span> per share
                        </div>
                      </div>
                      <div class="mt-6 flex-auto rounded-t-2xl bg-white">
                        <div class="px-4 py-6">
          ...
          <div class="mt-6 flex justify-center gap-3">
            ...
            >
              <span class="absolute -inset-x-1.5 -inset-y-3"></span></button
            ><button
              type="button"
              class="relative h-0.5 w-4 rounded-full bg-gray-500"
                ...
                <div class="relative z-10 p-8">
                  ...
                  <h3 class="mt-6 text-lg font-semibold text-white">
                    <button
                      ...
                      id="headlessui-tabs-tab-:Rabd6m:"
                      role="tab"
                      type="button"
                      aria-selected="true"
                      tabindex="0"
                      data-headlessui-state="selected"
                      aria-controls="headlessui-tabs-panel-:Rald6m:"
                    >
              ...
              >
                ...
                >
                  <div
                    ...
                    id="headlessui-tabs-panel-:Rald6m:"
                    role="tabpanel"
                    tabindex="0"
                    data-headlessui-state="selected"
                    aria-labelledby="headlessui-tabs-tab-:Rabd6m:"
                  >
                    <div class="flex flex-col w-full">
                      <div class="flex justify-between px-4 pt-4">
                        <svg
      ...
      >
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div
              class="pointer-events-none absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-gray-50"
            ></div>
            <div
              class="pointer-events-none absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-gray-50"
            ></div>
          </div>
        </div>
      </section> -->
          ...
          <div class="mt-8 flex justify-center">
            <div class="relative">
              <div
                ...
                id="headlessui-radiogroup-:Rr6m:"
                role="radiogroup"
              >
                <div
                  class="cursor-pointer border border-gray-300 py-[calc(theme(spacing.2)-1px)] px-[calc(theme(spacing.3)-1px)] text-sm text-gray-700 outline-2 outline-offset-2 transition-colors hover:border-gray-400 rounded-l-lg"
                  id="headlessui-radiogroup-option-:Rqr6m:"
                  role="radio"
                  aria-checked="true"
                  tabindex="0"
                ...
                <div
                  class="cursor-pointer border border-gray-300 py-[calc(theme(spacing.2)-1px)] px-[calc(theme(spacing.3)-1px)] text-sm text-gray-700 outline-2 outline-offset-2 transition-colors hover:border-gray-400 -ml-px rounded-r-lg"
                  id="headlessui-radiogroup-option-:R1ar6m:"
                  role="radio"
                  aria-checked="false"
                  tabindex="-1"
                  data-headlessui-state=""
              ...
              >
                <div
                  class="py-2 text-center text-sm font-semibold text-white [&amp;:not(:focus-visible)]:focus:outline-none"
                >
                  Monthly
                </div>
                <div
                  class="py-2 text-center text-sm font-semibold text-white [&amp;:not(:focus-visible)]:focus:outline-none -ml-px"
                >
                  Annually
                </div>
              </div>
