<template>
  <div class="relative bg-white my-24">
...
<!-- <template>
  <div class="m-auto flex w-full max-w-2xl flex-col sm:px-6 py-6">
    <div class="flex flex-col items-center gap-6">
      <a aria-label="Home" href="/" class="flex justify-center">
        <svg
          viewBox="0 0 40 40"
          aria-hidden="true"
          width="40"
      ...
      <div class="font-bold text-2xl">Contact us about your idea</div>
    </div>

    <div
      class="bg-white shadow-2xl shadow-gray-900/10 !p-4 md:!p-12 rounded-lg"
    >
      <form>
